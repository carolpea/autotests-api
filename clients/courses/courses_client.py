...
class CoursesClient(APIClient):
    ...
    def get_courses(self, query: GetCoursesQuerySchema) -> GetCoursesResponseSchema:
        ...
        :param query: Модель с userId.
        :return: Модель со списком курсов.
        """
    ...
    def create_course(self, request: CreateCourseRequestSchema) -> CreateCourseResponseSchema:
        ...
        :param request: Модель с данными нового курса.
        :return: Модель с данными созданного курса.
        """
    ...
    def update_course(self, course_id: str, request: UpdateCourseRequestSchema) -> UpdateCourseResponseSchema:
        ...
        :param course_id: Идентификатор курса.
        :param request: Модель с title, maxScore, minScore, description, estimatedTime.
        :return: Модель с данными обновленного курса.
        """
